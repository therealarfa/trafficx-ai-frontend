...
const Sidebar = ({ isOpen, setSidebarOpen }) => {
  ...
  return (
    <>
      ...
      <aside className={`fixed left-0 top-16 h-[calc(100vh-4rem)] bg-dark-800/95 backdrop-blur-xl border-r border-primary/10 transition-all duration-300 z-40 w-64 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
